...
public class NoRuleSingleFlow extends BaseClass {
	...
	public void orginator_with_valid_credentials_they_login() throws InterruptedException {

		LoginPage l = new LoginPage();
		l.login("jagadeesh@qaoncloud.com");
		WebElement getCompanyButton = driver.findElement(By.xpath("(//button[@type='button'])[1]"));
	...
	public void orginator_set_the_norule_for_transaction() throws InterruptedException {
		...
		WebElement getCompanyButton = driver.findElement(By.cssSelector(
				"body > div:nth-child(2) > div:nth-child(12) > section:nth-child(1) > div:nth-child(6) > div:nth-child(1) > div:nth-child(1)"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click()", getCompanyButton);
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_below_threshhold_value() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("0.45", "ETH", "testPro1", "testPro1",
				"testPro1", "testPro1", "testPro1",
				"testPro1", "testPro1", "testPro1");
		Thread.sleep(3000);
	}
	...
	public void orginator_do_transaction_with_valid_amount() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testPro2", "testPro2",
				"testPro2", "testPro2", "testPro2",
				"testPro2", "testPro2", "testPro2");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_secound_time() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testPro3", "testPro3",
				"testPro3", "testPro3", "testPro3",
				"testPro3", "testPro3", "testPro3");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_third_time() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testPro4", "testPro4",
				"testPro4", "testPro4", "testPro4",
				"testPro4", "testPro4", "testPro4");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_fourth_time() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testPro5", "testPro5",
				"testPro5", "testPro5", "testPro5",
				"testPro5", "testPro5", "testPro5");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_fifth_time() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testPro6", "testPro6", "testPro6", "testPro6",
				"testPro6", "testPro6", "testPro6", "testPro6");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_below_threshhold_value_in_basic_rule()
		...
		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("0.45", "ETH", "testnote1", "testnote1", "testnote1", "testnote1", "testnote1", "testnote1",
				"testnote1", "testnote1");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_with_basic_rule() throws AWTException, InterruptedException {

		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testnote2", "testnote2", "testnote2", "testnote2", "testnote2", "testnote2",
				"testnote2", "testnote2");
		Thread.sleep(3000);
	...
	public void orginator_do_transaction_with_valid_amount_secound_time_with_basic_rule()
		...
		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testnote3", "testnote3", "testnote3", "testnote3", "testnote3", "testnote3",
				"testnote3", "testnote3");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[normalize-space()='All']")).click();
		Thread.sleep(5000);
	...
	public void orginator_do_transaction_with_valid_amount_third_time_with_basic_rule()
		...
		Create_New_Transaction c = new Create_New_Transaction();
		c.newTransaction("1.40", "ETH", "testnote4", "testnote4", "testnote4", "testnote4", "testnote4", "testnote4",
				"testnote4", "testnote4");
		Thread.sleep(3000);
